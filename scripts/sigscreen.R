...
option_list <- list(
  ...
  make_option(c("-r", "--ref"), type = "character", default = "hg19",
              help = "Reference genome used for mutation calling [default: %default].", metavar = "genome"),
  make_option(c("--db_sbs"), type = "character", default = NULL,
  ...
  make_option(c("--db_indel"), type = "character", default = NULL,
  ...
  make_option(c("--db_dbs"), type = "character", default = NULL,
  ...
  make_option(c("--db_cn"), type = "character", default = NULL,
  ...
  make_option(c("--db_sv"), type = "character", default = NULL,
